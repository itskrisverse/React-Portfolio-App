...
const Data = () => {
  return (
    ...
    <h1 className="home__title">KrisVerse
    <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
    ...
    <p className="home__description">I'm a passionate developer with a passion for building beautiful, intuitive, and accessible
websites. I love to learn and explore new technologies.
    </p>
